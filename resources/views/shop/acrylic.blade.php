        ...
        <div class="row">
            @forelse($products as $product)
                <div class="col-md-4 mb-4">
                    <div class="card shadow-sm h-100">
                        @if($product->image)
                            <a href="#" data-toggle="modal" data-target="#acrylicModal{{ $product->id }}">
                ...
                <!-- Modal for Acrylic Product -->
                <div class="modal fade" id="acrylicModal{{ $product->id }}" tabindex="-1" role="dialog" aria-labelledby="acrylicModalLabel{{ $product->id }}" aria-hidden="true">
            ...
            @empty
                <div class="col-12 text-center">
                    <p>No acrylic products available right now.</p>
                </div>
            @endforelse
        </div>
    </div>
